              ...
              <Stack spacing={2} marginTop="15px">
                ...
                >
                  <Typography variant="h5">
                    ...
                    Kident Disease, Liver Disease, Babesiosis, Genetic Disorder?
                  </Typography>
                  <Box>
                    <Button
                      size="small"
          ...
          <Card variant="outlined" sx={{ marginTop: "15px" }}>
            <CardContent>
              <Stack spacing={2} marginTop="15px">
                ...
                >
                  <Typography variant="h5">
                    Do you currently have or are you being treated for any type
                    of inection?
                  </Typography>
                  <Box>
                    <Button
              ...
              <Stack spacing={2} marginTop="15px">
                ...
                >
                  <Typography variant="h5" maxWidth="930px">
                    ...
                    suffered from Malaria, Chikungunya, Dengueand West Nile
                    Fever?
                  </Typography>
                  <Box>
                    <Button
