...
const BabyDetailsForm = () => {
  ...
  return (
    <Card variant="outlined">
      ...
      >
        {showImageBox && formValues.Frames ? (
          <Box
            sx={{
              display: "flex",
          ...
          >
            <img
              src={`https://flyingbyts.s3.ap-south-2.amazonaws.com/${formValues.Frames}`}
              alt="frames"
              height={"600px"}
              width={"500px"}
            />
                      ...
                      <Grid item xs={6}>
                        ...
                        >
                          <OutlinedInput
                            ...
                            onChange={(e) =>
                              handleChange(e.target.value, "weight")
                            }
                          />
                          {!!errors.weight && (
                      ...
                      <Grid item xs={6}>
                        ...
                        >
                          <SingleSelect
                            ...
                            width={"100%"}
                            onChange={(e) =>
                              handleChange(e, "DeliveryDoctorName")
                            }
                          />
          ...
          >
            ...
            >
              ...
              <input
                ...
                accept="image/jpeg, image/png, image/svg+xml"
                hidden
                onChange={(e) => handleBabyImageUpload(e, "Frames")}
              />
            </Button>
          </CardContent>
        </Card>
